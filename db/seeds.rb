...
if Rails.env.production?
  Book.create!(title: "The Great Gatsby", author: "F. Scott Fitzgerald", price: 13.99, published_date: Date.new(1925, 4, 10))
  Book.create!(title: "Moby-Dick", author: "Herman Melville", price: 14.99, published_date: Date.new(1851, 10, 18))
end